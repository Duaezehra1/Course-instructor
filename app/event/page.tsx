...
export default function EventDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="p-0 overflow-hidden max-w-[400px] rounded-2xl bg-[#001F54]">
        <div className="flex items-center justify-between p-4 border-b border-[#002A6E]">
          <Button 
            variant="ghost" 
            className="text-[#FFB800] hover:text-[#FFB800]/90 p-0 h-auto font-normal text-sm"
          ...
          <Button 
            variant="ghost" 
            className="text-[#FFB800] hover:text-[#FFB800]/90 p-0 h-auto font-semibold text-sm"
            onClick={() => setOpen(false)}
          >
            Save
          </Button>
        ...
        <div className="p-4 space-y-4">
          <div className="bg-white text-black h-12 rounded-xl text-center border border-gray-300 flex items-center justify-center text-sm font-medium">Event</div>
          ...
          <div className="space-y-3">
            <div className="bg-white rounded-xl border border-gray-300 px-4 py-2 space-y-2">
